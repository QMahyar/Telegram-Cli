...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"telegram-cli auth login",
		"telegram-cli doctor",
		"telegram-cli help items",
		"telegram-cli sync",
		"telegram-cli profile list",
		"telegram-cli feedback list",
		"telegram-cli which",
		"telegram-cli agent-context",
		"telegram-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"telegram-cli teach",
		"telegram-cli recall",
		"telegram-cli learnings",
		"telegram-cli teach-pattern",
		"telegram-cli teach-lookup",
		"telegram-cli items list",
	}
