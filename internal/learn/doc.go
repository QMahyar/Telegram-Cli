...
// pattern-extraction algorithm originate in an earlier research CLI.
// This CLI ports them into a domain-neutral learn shape — no
// prediction-market vocabulary; the
