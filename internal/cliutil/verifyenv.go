...
// VerifyEnvVar is the env var the verification harness sets in every
...
const VerifyEnvVar = "TELEGRAM_VERIFY"
...
const VerifyLiveHTTPEnvVar = "TELEGRAM_VERIFY_LIVE_HTTP"
...
const DogfoodEnvVar = "TELEGRAM_DOGFOOD"

// IsVerifyEnv reports whether the current process is running under the
// verification harness in mock mode. Generated commands with side
